...
export default function Listitem({index}) {
  ...
  return (
    <div
        ...
        <img
          src="https://m.media-amazon.com/images/M/MV5BMTMxNzYwMjc1Ml5BMl5BanBnXkFtZTcwNDI3MDE3Mg@@._V1_FMjpg_UX1000_.jpg"
          alt=""
        />
      {isHovered && (
        <>
